...
#Load Data, read csv and transpose
gdp = pd.read_csv('GDP.csv',skiprows=0, header=None).T


#Transpose horizontal data
gdp = pd.read_csv('GDP.csv', skiprows=0, header=None).T   # Read csv, and transpose
...
inflation = pd.read_csv('Inflation 5.csv')


#Transpose Data
inflation = pd.read_csv('Inflation 5.csv', skiprows=0, header=None).T
